...
public class GameWon extends Stage {
    private Scene scene;
    private Label gameWon = new Label("YOU CLAIMED THE AETHER! "
            + "YOU WIN!!");
    ...
    public GameWon() {
        gameWon.setStyle("-fx-font-size: 75px");
        credits.setStyle("-fx-font-size: 40px");
        title.getChildren().addAll(gameWon);
